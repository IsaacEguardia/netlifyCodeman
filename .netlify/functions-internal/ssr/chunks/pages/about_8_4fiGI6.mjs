...
import 'kleur/colors';
import 'clsx';
import { a as $$MainLayout } from './Passwordseguros_lXrFkMie.mjs';

const $$Astro = createAstro();
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "About Me", "description": "Lorem ipsum dolor sit amet", "mainClass": "container py-10" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="space-y-5"> <h1 class="font-heading text-4xl">About Page</h1> <p>
...
}, "C:/Users/iescobar/Downloads/codeman v4/astro-nomy/src/pages/about.astro", void 0);

const $$file = "C:/Users/iescobar/Downloads/codeman v4/astro-nomy/src/pages/about.astro";
const $$url = "/about";
